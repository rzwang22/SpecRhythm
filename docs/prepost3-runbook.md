...
See [protocol and source-level accounting](serial-prepost3-design.md). The pinned
copyable launch command is appended by the delivery commit after the execution
commit SHA exists.
