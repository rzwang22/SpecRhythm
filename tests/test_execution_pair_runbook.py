...
SCRIPT = Path("scripts/run_execution_pair_b16.sh")
SHA = "a" * 40
POINTS = ["serial:runtime", "serial-eager:runtime"]
...
""",
    ...
    if failure == "none":
        ...
        assert len(list(results.glob("execution-runtime-pair-*.json"))) == 1
    else:
