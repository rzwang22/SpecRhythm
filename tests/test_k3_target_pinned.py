...
ENTRY = Path(__file__).resolve().parents[1] / "scripts/run_k3_target_pinned.sh"
SHA = "4ff1170397db0393caa2d8a43c2089a8e602ddfd"


@pytest.mark.parametrize(
    "configuration", ["baseline", "lean-target"]
)
...
@pytest.mark.parametrize("args", [["lean-target-dispatch"], ["baseline", "b128"]])
